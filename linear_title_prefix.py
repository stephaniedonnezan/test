...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    The automation payload may be flat or may carry the Linear issue fields
    under ``triggerContext`` or ``data``. Return ``None`` when the event does
    not describe a status change to the target status or cannot be updated.
    """
