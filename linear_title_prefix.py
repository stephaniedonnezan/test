...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    The Cursor automation trigger may pass the Linear payload either as the
    whole event or under ``triggerContext``. This helper accepts both shapes and
    returns ``None`` when the payload is not a status change into "to research".
    """
