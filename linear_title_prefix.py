...
Cursor and Linear webhook payloads can be flat or nested depending on the
trigger source. This module keeps the mutation decision deterministic: when a
status-change event moves an issue to "to research", return the title update
...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    """Return a title-update action for issues entering the research state."""
