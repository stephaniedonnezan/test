...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    Cursor automations can receive a flat ``triggerContext`` payload, while
    native Linear webhooks usually include a nested issue under ``data``. Keeping
    this function pure lets callers decide how to apply the returned action.
    """
