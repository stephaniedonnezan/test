"""Helpers for marking Linear issue titles when research starts."""
...
def _prefix_title(title: str, prefix: str = RESEARCH_TITLE_PREFIX) -> str:
    """Add the research marker to a title without duplicating it."""
...
def update_issue_title_for_status(title: str, new_status: str) -> str:
    """Return a title marked for Cursor research when status is to research."""
...
def derive_updated_title(payload: Mapping[str, Any]) -> str | None:
    """Derive the updated title from a Linear automation trigger payload."""
