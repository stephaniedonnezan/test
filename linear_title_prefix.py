...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    Cursor automation trigger payloads can be compact, while Linear webhook
    payloads can nest issue details in ``triggerContext``, ``data``, or
    ``issue`` objects. This accepts those common shapes and returns a
    side-effect-free action for the caller to apply.
    """
