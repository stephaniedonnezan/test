...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    The automation webhook payloads used by Cursor can be either flat or nested
    below ``triggerContext``/``data``/``issue``. This helper normalizes those
    shapes and stays idempotent by skipping titles that are already prefixed.
    """
