...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    The function is side-effect free so automation runners can pass the returned
    action to whichever Linear client they use. Unrelated or malformed payloads
    return ``None``.
    """
    ...
    if _has_research_prefix(issue_title):
        return None
