...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    Cursor/Linear webhook payloads used by automations are not perfectly
    uniform, so this accepts flat trigger contexts, Cloud automation wrappers,
    and common nested Linear webhook shapes.
    """
