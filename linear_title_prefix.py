...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    webhooks often nest issue data under ``data.issue``. This function accepts
    both shapes and returns ``None`` for irrelevant events.
    """
...
def _records_from_event(event: Mapping[str, Any]) -> Iterable[Mapping[str, Any]]:
    """Yield plausible metadata and issue records in priority order."""
