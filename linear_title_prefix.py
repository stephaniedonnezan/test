...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    Cursor automation trigger payloads are intentionally small, while Linear
    webhook payloads can nest the issue and status metadata in several places.
    This function accepts both shapes by scanning likely payload sections.
    """
