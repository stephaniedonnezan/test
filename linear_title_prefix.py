...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    """Return a title-update action when an issue enters To Research.

    The Cursor/Linear webhook payloads used by automations are not perfectly
    uniform, so this function accepts flat trigger contexts, Cloud automation
    wrappers, and common nested Linear webhook shapes.
    """
