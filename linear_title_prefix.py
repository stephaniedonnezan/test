...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    if _normalize_status(_first_present(payload, "newStatus", "new_status", "status")) != TARGET_STATUS:
...
def _is_status_changed(event: Mapping[str, Any], payload: Mapping[str, Any]) -> bool:
    ...
    payload_trigger_value = _first_present(payload, "trigger", "webhookType", "action", "type")
    return _normalize_event_name(trigger_value) == "statuschanged" or _normalize_event_name(payload_trigger_value) == "statuschanged"
