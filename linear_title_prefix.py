...
def _prefix_title(title: str, prefix: str = RESEARCH_TITLE_PREFIX) -> str:
    """Prefix title while avoiding duplicate research markers."""
...
def derive_updated_title(payload: Mapping[str, Any]) -> str | None:
    """Derive the updated title from a Linear automation webhook payload."""
...
def build_issue_title_update(payload: Mapping[str, Any]) -> dict[str, str] | None:
    """Build the automation action for updating the Linear issue title."""
