...
def _is_status_change_event(payload: Mapping[str, Any]) -> bool:
    ...
    if normalized_triggers.intersection({"update", "updated", "issue updated", "updated issue"}):
        return _payload_marks_status_updated(payload)

    return _payload_marks_status_updated(payload)


def _payload_marks_status_updated(payload: Mapping[str, Any]) -> bool:
