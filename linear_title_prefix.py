...
The automation trigger payloads used by Cursor and Linear can be flat or nested.
This module keeps the decision small and deterministic: when a status-change
event moves an issue to "to research", return the issue-title update to apply.
"""
...
def build_issue_title_update(event: Mapping[str, Any]) -> dict[str, str] | None:
    ...
    The returned shape is intentionally simple so callers can hand it to the
    integration layer that performs the actual Linear mutation.
    """
