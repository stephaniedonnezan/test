...
The automation trigger payloads used by Cursor and Linear can be flat or
nested. This module keeps the decision small and deterministic: when a
status-change event moves an issue to "to research", return the issue-title
update to apply.
"""
