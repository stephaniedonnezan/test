...
def _flatten_event_context(event: Mapping[str, Any]) -> dict[str, Any]:
    ...
    automation_trigger_context = event.get("automation_trigger_info")
    if isinstance(automation_trigger_context, Mapping):
        automation_trigger_context = automation_trigger_context.get(
            "triggerContext", automation_trigger_context
        )
