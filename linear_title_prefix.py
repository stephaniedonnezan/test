...
Cursor automation and Linear webhook payloads can be flat or nested depending
on the trigger source. This module extracts the relevant issue fields and only
returns an update when an issue status changes to "to research".
"""
