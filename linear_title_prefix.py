...
def build_issue_title_update(event: Mapping[str, Any] | None) -> dict[str, str] | None:
    ...
    The function is side-effect free so automation runners can pass the result to
    their preferred Linear client. It returns ``None`` for unrelated events,
    malformed payloads, non-target statuses, or already-prefixed titles.
    """
    ...
    if _normalize(_issue_status(contexts)) != TARGET_STATUS:
        return None
