...
class TestLinearResearchTitlePrefix(unittest.TestCase):
    ...
    def test_extract_identifier_from_url(self) -> None:
        trigger_context = {
            "url": "https://linear.app/atmen/issue/POI-4050/redispatch-imbalance-settlement",
        }
        self.assertEqual(extract_identifier(trigger_context), "POI-4050")
    ...
    def test_process_trigger_updates_when_to_research(self) -> None:
                        ...
                        "nodes": [
                            {
                                "id": "uuid-1",
                                "identifier": "POI-4050",
                                "title": "Redispatch /Imbalance settlement",
                            }
                        ]
                    }
                }
        ...
        self.assertEqual(result["title"], "Cursor researching: Redispatch /Imbalance settlement")
