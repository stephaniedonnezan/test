    ...
    def test_prefixes_title_for_status_changed_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4547",
                "title": "Add list of sustainability documents under document database",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4547",
                "title": "Cursor researching: Add list of sustainability documents under document database",
            },
        )
