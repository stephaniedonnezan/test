...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_flat_status_changed_event(self):
        event = {
            ...
            "id": "POI-5094",
            "title": "Refactor out the h2 provider into separate core hydrogen module",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Refactor out the h2 provider into separate core hydrogen module"
                ),
            },
        )
    ...
    def test_accepts_cursor_automation_trigger_wrapper(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Refactor out the h2 provider into separate core hydrogen module",
        )

    def test_accepts_camel_case_cursor_automation_wrapper(self):
        event = {
        ...
        self.assertEqual(build_issue_title_update(event)["issueId"], "POI-5094")
