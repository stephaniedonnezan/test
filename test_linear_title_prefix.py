    ...
    def test_prefixes_title_for_nested_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-3005",
                "title": "Questionnaire to collect inputs for Mgmt Sys Doc",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-3005",
                "title": (
                    "Cursor researching: Questionnaire to collect inputs for "
                    "Mgmt Sys Doc"
                ),
            },
        )
    ...
    def test_uses_status_when_new_status_is_missing(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-124",
                "title": "Cursor researching: Trace Linear status",
            },
        )
