...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    ...
    def test_accepts_cloud_automation_trigger_info_payload(self):
        event = {
            "automation_trigger_info": {
                ...
                "triggerContext": {
                    ...
                    "newStatus": "To Research",
                    "id": "POI-5044",
                    "title": "Do we always know weather an offtaker has to report downstream emissions?",
                },
            },
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-5044",
                "title": (
                    "Cursor researching: Do we always know weather an offtaker has to "
                    "report downstream emissions?"
                ),
            },
        )
