...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_trigger_context_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-3966",
                "title": "Maintain delivery links after modification",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-3966",
                "title": "Cursor researching: Maintain delivery links after modification",
            },
        )
    ...
    def test_trims_title_before_prefixing(self):
        ...
        self.assertEqual(
            build_issue_title_update(event)["title"],
            "Cursor researching: Maintain delivery links after modification",
        )
