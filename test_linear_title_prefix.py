...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_when_status_changes_to_research(self):
        event = {
            ...
            "id": "POI-4453",
            "title": "Update the excel upload to include these columns",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4453",
                "title": "Cursor researching: Update the excel upload to include these columns",
            },
        )
    ...
    def test_accepts_camel_case_status_and_trigger(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Update the excel upload to include these columns",
        )
    ...
    def test_skips_missing_or_blank_issue_id_or_title(self):
        self.assertIsNone(
        ...
        self.assertIsNone(
            build_issue_title_update(
                {"trigger": "status_changed", "newStatus": "to research", "id": "POI-4453"}
            )
        )
        self.assertIsNone(
            build_issue_title_update(
