...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_adds_prefix_for_to_research_status_change(self) -> None:
        event = {
            "triggerContext": {
                ...
                "id": "POI-3791",
                "title": "Clarify with Harold regarding pipeline EFs from ISCC",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-3791",
                "title": "Cursor researching: Clarify with Harold regarding pipeline EFs from ISCC",
            },
        )
    ...
    def test_accepts_camel_case_target_status(self) -> None:
        event = {
            ...
            "status": "toResearch",
            "issue_id": "POI-3791",
            "name": "Clarify with Harold regarding pipeline EFs from ISCC",
        }
