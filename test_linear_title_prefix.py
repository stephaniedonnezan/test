    ...
    def test_prefixes_flat_status_changed_payload_for_to_research(self):
        event = {
            ...
            "triggerContext": {
                ...
                "id": "POI-4759",
                "title": (
                    "[MB Export] Discrepancies between Energy Allocation export "
                    'Vs. MB export "Grid Consumption" tab'
                ),
            },
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4759",
                "title": (
                    "Cursor researching: [MB Export] Discrepancies between Energy "
                    'Allocation export Vs. MB export "Grid Consumption" tab'
                ),
            },
        )
    ...
    def test_prefixes_linear_automation_trigger_payload_for_to_research(self):
        event = {
            ...
            "triggerContext": {
                ...
                "id": "POI-4759",
                "url": (
                    "https://linear.app/atmen/issue/POI-4759/"
                    "mb-export-discrepancies-between-energy-allocation-export-vs-mb-export"
                ),
                "status": "To Research",
    ...
    def test_ignores_already_prefixed_title_case_insensitively(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4759",
                "title": "cursor researching: [MB Export] Discrepancies",
            },
        }
