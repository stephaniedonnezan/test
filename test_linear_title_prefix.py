...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_flat_status_changed_to_research_prefixes_title(self) -> None:
        event = {
            "triggerContext": {
    ...
    def test_accepts_linear_update_when_status_field_changed(self) -> None:
        event = {
            "action": "update",
    ...
    def test_ignores_update_without_status_field_change(self) -> None:
        event = {
            "action": "update",
            "updatedFields": ["title"],
            "status": "to research",
    ...
    def test_cli_prints_update_action_for_matching_payload(self) -> None:
        event = {
            "triggerContext": {
                "trigger": "status_changed",
                "newStatus": "to research",
