...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_flat_status_changed_to_research_prefixes_title(self):
        event = {
            ...
            "id": "POI-4867",
            "title": "Switching tabs in site view causes random mass balance load errors",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4867",
                "title": "Cursor researching: Switching tabs in site view causes random mass balance load errors",
            },
        )
    ...
    def test_handle_issue_status_changed_entrypoint_matches_builder(self):
        event = {
            "trigger": "status_changed",
            "newStatus": "to research",
            "identifier": "POI-42",
            "title": "Entrypoint compatibility",
        }
    ...
    def test_current_blocked_trigger_is_ignored(self):
        event = {
            "automation_trigger_info": {
                "triggerContext": {
                    "trigger": "status_changed",
