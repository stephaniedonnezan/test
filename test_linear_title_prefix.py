...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    ...
    def test_prefixes_automation_trigger_payload(self):
        event = {
            ...
            "triggerContext": {
                ...
                "trigger": "status_changed",
                "newStatus": "to research",
                "title": "Rename the sites and org names in the methane demo to be clearer",
                "id": "POI-4798",
                "url": "https://linear.app/atmen/issue/POI-4798/example",
                "status": "to research",
            },
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4798",
                "title": (
                    "Cursor researching: Rename the sites and org names in "
                    "the methane demo to be clearer"
                ),
            },
        )
