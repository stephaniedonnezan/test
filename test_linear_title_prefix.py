...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_nested_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4040",
                "title": "audit: assign controls/evidence to users & notify them",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4040",
                "title": "Cursor researching: audit: assign controls/evidence to users & notify them",
            },
        )
    ...
    def test_trims_title_before_prefixing(self):
        ...
        self.assertEqual(
            build_issue_title_update(event)["title"],
            "Cursor researching: audit: assign controls/evidence to users & notify them",
        )
