...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_updates_title_for_trigger_context_status_changed_to_research(self):
        event = {
            ...
            "triggerContext": {
                ...
                "id": "POI-4632",
                "title": "Qualified inputs linked to a closed mass balance can still be modified via API",
            },
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4632",
                "title": (
                    "Cursor researching: Qualified inputs linked to a closed mass balance can still "
                    "be modified via API"
                ),
            },
        )
    ...
    def test_does_not_update_for_todo_status(self):
        event = {
            "trigger": "status_changed",
            "newStatus": "Todo",
            "id": "POI-4632",
    ...
    def test_does_not_duplicate_existing_prefix_case_insensitively(self):
        event = {
            ...
            "newStatus": "to research",
            "id": "POI-4632",
            "title": "cursor researching: Qualified inputs linked to a closed mass balance",
        }
