    ...
    def test_builds_update_for_flat_status_changed_payload(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4727",
                "title": "Methane demo include some non-compliant co2 qualified input",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4727",
                "title": "Cursor researching: Methane demo include some non-compliant co2 qualified input",
            },
        )
