...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_flat_status_change_payload(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4960",
                "title": (
                    "Cursor researching: User & permission management (Org Admin)"
                ),
            },
        )
    ...
    def test_prefixes_trigger_context_payload(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4960",
                "title": "Cursor researching: User and permission management",
            },
        )
    ...
    def test_accepts_nested_linear_issue_payload(self):
        event = {
            ...
            "data": {
                "identifier": "POI-4960",
                "title": "Invite users with initial roles",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4960",
                "title": "Cursor researching: Invite users with initial roles",
            },
        )
    ...
    def test_accepts_changed_status_new_value(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4960",
                "title": "Cursor researching: Audit role changes",
            },
        )
    ...
    def test_prefers_issue_identifier_over_webhook_event_id(self):
        ...
        self.assertEqual(build_issue_title_update(event)["issueId"], "POI-4960")
    ...
    def test_ignores_other_statuses(self):
        event = {
            ...
            "id": "POI-4960",
            "title": "Do not update review-ready issues",
        }
