...
class LinearTitlePrefixTest(unittest.TestCase):
    ...
    def test_accepts_case_and_separator_variations_for_research_status(self):
        event = {
            "trigger": "statusChanged",
            "newStatus": "to-research",
            "identifier": "POI-789",
            "title": "Review denominator source",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-789",
                "title": "Cursor researching: Review denominator source",
            },
        )
