    ...
    def test_prefixes_flat_status_changed_trigger_context(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4818",
                "title": (
                    "If manual allocation doesn't 100% match, it should not fail like a "
                    "shit, but give an error to the user"
                ),
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4818",
                "title": (
                    "Cursor researching: If manual allocation doesn't 100% match, it "
                    "should not fail like a shit, but give an error to the user"
                ),
            },
        )
    ...
    def test_ignores_already_prefixed_titles(self):
        event = {
            "triggerContext": {
                ...
                "newStatus": "to research",
                "id": "POI-4818",
                "title": "cursor researching: Manual allocation error",
            }
        }
