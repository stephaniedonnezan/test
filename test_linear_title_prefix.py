...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    ...
    def test_changes_status_wins_over_stale_nested_issue_state(self):
        update = build_issue_title_update(
            {
                "action": "update",
                "type": "Issue",
        ...
        self.assertEqual(update["issueId"], "POI-655")
        self.assertEqual(update["title"], "Cursor researching: Changed state payload")
