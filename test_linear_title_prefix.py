...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_flat_status_changed_payload(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4870",
                "title": "Container allocation view loads too slowly",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4870",
                "title": "Cursor researching: Container allocation view loads too slowly",
            },
        )
    ...
    def test_skips_current_blocked_trigger_payload(self):
        event = {
            "automation_trigger_info": {
                "triggerContext": {
                    "triggerType": "linear",
