...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_when_status_changes_to_research(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4491",
                "title": f"{CURSOR_RESEARCHING_PREFIX}: N+1 Query",
            },
        )
    ...
    def test_accepts_flat_payloads(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4491",
                "title": f"{CURSOR_RESEARCHING_PREFIX}: Investigate query count",
            },
        )
    ...
    def test_accepts_issue_id_field(self):
        event = {
            "triggerContext": {
                ...
                "newStatus": "to research",
                "issueId": "POI-4491",
                "title": "Investigate issue id field",
            }
        }
    ...
    def test_accepts_root_issue_fields_when_context_has_status(self):
        event = {
            "triggerContext": {
                "trigger": "status_changed",
                "newStatus": "to research",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4491",
                "title": f"{CURSOR_RESEARCHING_PREFIX}: Root issue fields",
            },
        )
