    ...
    def test_prefixes_flat_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4999",
                "title": "If no loading event, still show production amount",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "If no loading event, still show production amount"
                ),
            },
        )
    ...
    def test_supports_nested_linear_update_payload(self):
        event = {
            ...
            "data": {
                "issue": {
                    "identifier": "POI-4999",
                    "title": "Production amount missing from site view",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Production amount missing from site view"
                ),
            },
        )
