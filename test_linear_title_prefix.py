    ...
    def test_prefixes_title_for_trigger_context_to_research_status(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-3883",
                "title": "Create a sales demo simulation test",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-3883",
                "title": "Cursor researching: Create a sales demo simulation test",
            },
        )
    ...
    def test_accepts_issue_updated_when_status_field_changed(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-2",
                "title": "Cursor researching: Research webhook shape",
            },
        )
