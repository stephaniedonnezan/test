...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_trigger_context_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4418",
                "title": "[Atmen Newsletter] - Create an Atmen Newsletter signup button",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "[Atmen Newsletter] - Create an Atmen Newsletter signup button"
                ),
            },
        )
    ...
    def test_accepts_linear_update_state_change_payload(self):
        event = {
