...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_when_status_changes_to_research(self):
        event = {
            ...
            "id": "POI-4626",
            "title": "RFBNO Compliance go live",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4626",
                "title": "Cursor researching: RFBNO Compliance go live",
            },
        )
    ...
    def test_accepts_nested_trigger_context_payload(self):
        event = {
            "triggerContext": {
                ...
                "newStatus": "To Research",
                "id": "POI-4626",
                "title": "Investigate access setup",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4626",
                "title": "Cursor researching: Investigate access setup",
            },
        )
    ...
    def test_accepts_automation_trigger_context_shape(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4626",
                "title": "Cursor researching: Review production rollout",
            },
        )
    ...
    def test_accepts_camel_case_status(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Investigate access setup",
        )
    ...
    def test_skips_missing_issue_id_or_title(self):
        ...
        self.assertIsNone(
            build_issue_title_update(
                {"trigger": "status_changed", "newStatus": "to research", "id": "POI-4626"}
            )
        )
