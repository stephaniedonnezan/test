...
class BuildIssueTitleUpdateTests(unittest.TestCase):
    def test_flat_cursor_status_changed_to_research_adds_prefix(self):
        event = {
            ...
            "id": "POI-5018",
            "title": "Error alert with repeating txt when entering high amount of proposed GO",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-5018",
                "title": (
                    "Cursor researching: Error alert with repeating txt when entering "
                    "high amount of proposed GO"
                ),
            },
        )
