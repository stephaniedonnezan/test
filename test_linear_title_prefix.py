    ...
    def test_prefixes_title_for_flat_status_changed_payload(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-5098",
                "title": "Allow transports from Supplier location",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-5098",
                "title": "Cursor researching: Allow transports from Supplier location",
            },
        )
    ...
    def test_prefixes_title_for_cloud_automation_wrapper(self):
        event = {
            "automation_trigger_info": {
                "triggerContext": {
                    ...
                    "newStatus": "to research",
                    "id": "POI-3950",
                    "title": "Turn2x electricity units are wrong",
                    "status": "To Research",
                }
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-3950",
                "title": "Cursor researching: Turn2x electricity units are wrong",
            },
        )
