    ...
    def test_prefixes_title_for_nested_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-3636",
                "title": (
                    "Bug: downloading POS from Documents database does not "
                    "include .pdf suffix on windows"
                ),
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-3636",
                "title": (
                    "Cursor researching: Bug: downloading POS from "
                    "Documents database does not include .pdf suffix on windows"
                ),
            },
        )
