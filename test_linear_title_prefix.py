...
class UpdateIssueTitleForStatusTests(unittest.TestCase):
    def test_fills_empty_title_marker_for_to_research(self) -> None:
        self.assertEqual(
            update_issue_title_for_status(
                title="[][Dev] - Leadmagnet ISCC to Nabisy",
                new_status="to research",
            ),
            "[Cursor researching][Dev] - Leadmagnet ISCC to Nabisy",
        )

    def test_adds_prefix_when_no_empty_marker_exists(self) -> None:
        self.assertEqual(
            update_issue_title_for_status(
                title="Leadmagnet ISCC to Nabisy",
                new_status="to research",
            ),
            "Cursor researching - Leadmagnet ISCC to Nabisy",
        )
    ...
    def test_does_not_duplicate_bracketed_marker(self) -> None:
        self.assertEqual(
            update_issue_title_for_status(
                title="[Cursor researching][Dev] - Some issue",
                new_status="to research",
            ),
            "[Cursor researching][Dev] - Some issue",
        )
...
class DeriveUpdatedTitleTests(unittest.TestCase):
    def test_returns_updated_title_when_payload_matches(self) -> None:
        ...
        self.assertEqual(
            ...
            "[Cursor researching][Dev] - Issue title",
        )
...
class CliTests(unittest.TestCase):
    def test_cli_reads_input_file_and_returns_json_output(self) -> None:
        ...
        self.assertEqual(
            ...
            {"updatedTitle": "[Cursor researching][Dev] - Issue title"},
        )
