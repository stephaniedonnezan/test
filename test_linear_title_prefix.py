...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_status_changed_to_research(self):
        update = build_issue_title_update(
            {
                ...
                "id": "POI-4235",
                "title": "Get all unconsumed qualified inputs in Methanation Mass Balance",
            }
        )
        ...
        self.assertEqual(
            update,
            {
                ...
                "issueId": "POI-4235",
                "title": (
                    "Cursor researching: Get all unconsumed qualified inputs "
                    "in Methanation Mass Balance"
                ),
            },
        )
    ...
    def test_accepts_nested_cursor_trigger_context(self):
        ...
        self.assertEqual(update["issueId"], "POI-4235")
        self.assertEqual(update["title"], "Cursor researching: Fix duplicate meter readings")
