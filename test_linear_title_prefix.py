    ...
    def test_prefixes_flat_status_changed_trigger_context(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4812",
                "title": "Don't block consistent PoS issuing if there are LATER inconsistent events",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Don't block consistent PoS issuing if there are LATER inconsistent events"
                ),
            },
        )
