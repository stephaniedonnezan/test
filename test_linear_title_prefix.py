...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_builds_update_for_trigger_context_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-1515",
                "title": "[1000] mass balance sankey: line thickness",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-1515",
                "title": "Cursor researching: [1000] mass balance sankey: line thickness",
            },
        )
    ...
    def test_ignores_other_statuses(self):
        event = {
            ...
            "newStatus": "Canceled",
            "id": "POI-1515",
            "title": "Mass balance sankey line thickness",
        }
    ...
    def test_avoids_duplicate_prefix_case_insensitively(self):
        event = {
            ...
            "newStatus": "to research",
            "id": "POI-1515",
            "title": "cursor researching: Mass balance sankey line thickness",
        }
