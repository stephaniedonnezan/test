...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    ...
    def test_trigger_context_lowercase_to_research_prefixes_title(self):
        event = {
            "automationId": "automation-4577",
            "triggerContext": {
                "trigger": "status_changed",
                "newStatus": "to research",
                "id": "POI-4577",
                "title": "Add production site lower heating value setting",
            },
        }
        ...
        self.assertEqual(
            handle_issue_status_changed(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Add production site lower heating value setting"
                ),
            },
        )
