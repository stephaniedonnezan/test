...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_when_status_changes_to_research(self):
        event = {
            ...
            "id": "POI-4669",
            "title": "[O Auth 2.0] Shell IT Request for OAuth Support",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4669",
                "title": "Cursor researching: [O Auth 2.0] Shell IT Request for OAuth Support",
            },
        )
    ...
    def test_accepts_nested_trigger_context_payload(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4669",
                "title": "Cursor researching: Assess OAuth support",
            },
        )
    ...
    def test_accepts_camel_case_status(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Assess OAuth support",
        )
    ...
    def test_skips_missing_issue_id_or_title(self):
        ...
        self.assertIsNone(
            build_issue_title_update(
                {"trigger": "status_changed", "newStatus": "to research", "id": "POI-4669"}
            )
        )
