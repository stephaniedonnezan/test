    ...
    def test_prefixes_flat_status_changed_payload_for_to_research(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4758",
                "title": (
                    "Cursor researching: Add database checks on "
                    "transport-segment entity"
                ),
            },
        )
    ...
    def test_prefixes_linear_automation_trigger_payload_for_to_research(self):
        event = {
            ...
            "triggerContext": {
                ...
                "id": "POI-4758",
                "url": (
                    "https://linear.app/atmen/issue/POI-4758/"
                    "add-database-checks-on-transport-segment-entity"
                ),
                "status": "To Research",
                "statusType": "unstarted",
                "priority": "High",
                "assignee": "Unassigned",
                "project": "Container Transport Emission Calculation Module",
                "labels": "No labels",
            },
        }
