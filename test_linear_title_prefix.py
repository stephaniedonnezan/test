...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_when_status_changes_to_research(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4566",
                "title": f"{CURSOR_RESEARCHING_PREFIX}: When creating an Audit",
            },
        )
    ...
    def test_accepts_flat_payloads(self):
        event = {
            ...
            "newStatus": "to research",
            "id": "POI-4566",
            "title": "Investigate audit creation",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4566",
                "title": f"{CURSOR_RESEARCHING_PREFIX}: Investigate audit creation",
            },
        )
