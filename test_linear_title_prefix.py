    ...
    def test_prefixes_flat_cursor_status_change_payload(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4554",
                "title": "Bug: reopening a mass balance produces a duplicate credit/surplus batch",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4554",
                "title": "Cursor researching: Bug: reopening a mass balance produces a duplicate credit/surplus batch",
            },
        )
