...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_adds_prefix_for_cursor_status_change_trigger_context(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4768",
                "title": "narrow the convert function refactor",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4768",
                "title": "Cursor researching: narrow the convert function refactor",
            },
        )
    ...
    def test_accepts_camel_case_trigger_and_status(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: narrow the convert function refactor",
        )
    ...
    def test_ignores_missing_issue_id_or_title(self):
        ...
        self.assertIsNone(
            build_issue_title_update(
                {"trigger": "status_changed", "newStatus": "to research", "id": "POI-4768"}
            )
        )
        self.assertIsNone(
            build_issue_title_update(
