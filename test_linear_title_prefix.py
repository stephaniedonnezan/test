...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_adds_prefix_for_cursor_status_change_trigger_context(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4265",
                "title": "Create an e2e test for the whole thing",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4265",
                "title": "Cursor researching: Create an e2e test for the whole thing",
            },
        )

    def test_adds_prefix_for_nested_cloud_automation_trigger_info(self):
        event = {
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4265",
                "title": "Cursor researching: Research nested trigger",
            },
        )
    ...
    def test_ignores_missing_issue_id_or_title(self):
        ...
        self.assertIsNone(
            build_issue_title_update(
                {"trigger": "status_changed", "newStatus": "to research", "id": "POI-4265"}
            )
        )
