...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    ...
    def test_supports_changed_status_values_from_changes_payload(self):
        event = {
            "action": "Issue Updated",
            "changes": {"workflowState": {"to": "to-research"}},
            "data": {
                "issue": {
                    "key": "POI-3333",
                    "title": "Map supplier gaps",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-3333",
                "title": "Cursor researching: Map supplier gaps",
            },
        )

    def test_status_changed_trigger_takes_precedence_over_outer_update_action(self):
        event = {
            "action": "update",
            "triggerContext": {
                "trigger": "status_changed",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-4444",
                "title": "Cursor researching: Document research scope",
            },
        )
