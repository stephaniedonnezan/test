...
class LinearTitlePrefixTests(unittest.TestCase):
    def test_top_level_cursor_trigger_context_to_research_returns_update(self):
        event = {
            "triggerContext": {
                "triggerType": "linear",
                "webhookType": "issue",
    ...
    def test_cursor_automation_trigger_context_is_supported(self):
        ...
        self.assertEqual(action["issueId"], "POI-4071")
    ...
    def test_changes_sequence_can_provide_new_status(self):
        event = {
            "action": "Issue Updated",
            "changes": [{"field": "state", "after": {"name": "To Research"}}],
            "id": "POI-4071",
            "title": "Add search",
        }
