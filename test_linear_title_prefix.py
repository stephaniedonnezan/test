...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_nested_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4159",
                "title": "Deliveries xls upload for trader is not blocked",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4159",
                "title": "Cursor researching: Deliveries xls upload for trader is not blocked",
            },
        )
    ...
    def test_accepts_linear_data_issue_payload(self):
        event = {
            ...
            "data": {
                "issue": {
                    "identifier": "POI-123",
                    "title": "Review producer MB closure rules",
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-123",
                "title": "Cursor researching: Review producer MB closure rules",
            },
        )
    ...
    def test_accepts_updated_issue_when_status_field_changed(self):
        event = {
            ...
            "status": "to-research",
            "issueId": "POI-124",
            "title": "Research delivery upload validation",
        }

        self.assertEqual(
            build_issue_title_update(event)["title"],
            "Cursor researching: Research delivery upload validation",
        )
    ...
    def test_skips_non_status_change_trigger(self):
        event = {
            "triggerContext": {
                ...
                "newStatus": "to research",
                "id": "POI-4159",
                "title": "Delivery upload validation",
            }
        }
    ...
    def test_skips_existing_prefix_case_insensitively(self):
        event = {
            ...
            "id": "POI-4159",
            "title": "cursor researching: Delivery upload validation",
        }
    ...
    def test_trims_title_before_prefixing(self):
        ...
        self.assertEqual(
            build_issue_title_update(event)["title"],
            "Cursor researching: Delivery upload validation",
        )
