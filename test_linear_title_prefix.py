...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_flat_cursor_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-4873",
                "title": "Delivery table layout shifts when expanding a row",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4873",
                "title": "Cursor researching: Delivery table layout shifts when expanding a row",
            },
        )
    ...
    def test_normalizes_trigger_and_status_names(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Delivery table layout shifts when expanding a row",
        )
