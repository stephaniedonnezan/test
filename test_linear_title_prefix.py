...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_nested_status_change_to_research(self):
        event = {
            "triggerContext": {
                ...
                "id": "POI-3964",
                "title": "Implement site-specific logic for low price hours calculation",
            }
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Implement site-specific logic for low price hours calculation"
                ),
            },
        )
    ...
    def test_skips_current_canceled_status_event(self):
        event = {
            "triggerContext": {
                "trigger": "status_changed",
                "webhookType": "issue",
