...
class BuildIssueTitleUpdateTests(unittest.TestCase):
    def test_flat_status_changed_payload_adds_prefix(self):
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "issueId": "POI-4120",
                "title": "Cursor researching: Improve error clarity",
            },
        )
    ...
    def test_nested_issue_id_wins_over_top_level_webhook_id(self):
        event = {
            "id": "webhook-event-id",
            "action": "Issue Updated",
            "updatedFields": ["state"],
            "data": {
                "issue": {
                    "identifier": "POI-457",
                    "title": "Review research automation",
                    "state": {"name": "To Research"},
                }
            },
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                "action": "update_issue_title",
                "issueId": "POI-457",
                "title": "Cursor researching: Review research automation",
            },
        )
