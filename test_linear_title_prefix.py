...
class BuildIssueTitleUpdateTest(unittest.TestCase):
    def test_prefixes_title_for_status_change_to_research(self):
        event = {
            ...
            "id": "POI-4640",
            "title": "Transaction saves all trips when closing one delivery",
        }
        ...
        self.assertEqual(
            build_issue_title_update(event),
            {
                ...
                "title": (
                    "Cursor researching: "
                    "Transaction saves all trips when closing one delivery"
                ),
            },
        )
    ...
    def test_accepts_issue_updated_when_status_field_changed(self):
        ...
        self.assertEqual(
            ...
            "Cursor researching: Transaction saves all trips when closing one delivery",
        )
