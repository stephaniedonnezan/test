...
def ensure_research_prefix(title: str, prefix: str = RESEARCH_PREFIX) -> str:
    """Add a prefix to the title if it is not already present."""
...
class TitleUpdate:
    """Represents a pending title mutation for an issue."""
...
def build_title_update(event_payload: dict[str, Any]) -> TitleUpdate | None:
    ...
    Expected payload shape follows Cursor automation trigger bodies:
    {
        "triggerContext": {
