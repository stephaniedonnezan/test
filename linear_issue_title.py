...
def _extract_trigger_context(payload: dict[str, Any]) -> dict[str, Any]:
    """Support either wrapped payloads or direct trigger-context payloads."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Apply Linear title updates for research status.")
    parser.add_argument(
        "--input",
